...
export const Offers = () => {
  ...
  return (
    <section className={styles.container}>
      <h3
        className={
          language ? styles.header : styles.headerKZ + " " + styles.header
        }
      >
        {language
          ? "Куда добавить диджитал-шильдик?"
          : "Диджитал-шильдті қайда қосуға болады?"}
      </h3>
      <div className={styles.offers_container}>
        {offers.map((offer, index) => (
          <div
            key={index}
            className={
              !language && offer.itemHeight
                ? styles.item2 + " " + styles.item
                : styles.item
            }
          >
            <div>
              <h4
                className={
                  language
                    ? styles.item_header
                    : styles.item_headerKZ + " " + styles.item_header
                }
              >
                {offer.header}
              </h4>
              <p
                className={
                  language
                    ? index === 1
                      ? styles.item_text2 + " " + styles.item_text
                      : styles.item_text
                    : styles.item_textKZ + " " + styles.item_text
                }
              >
                {offer.text}
              </p>
