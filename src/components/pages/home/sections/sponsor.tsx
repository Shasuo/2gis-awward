    ...
    >
      ...
      >
        ...
        >
          {language ? (
            <>
              Это сервис для аренды инструмента и&nbsp;строительного
              оборудования без залога.Сервис YouTool позволяет найти и
              арендовать нужный инструмент без залога и с доставкой.
            </>
          ) : (
            <>
